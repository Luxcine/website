  ...
  return (
    <section ref={ref} className="relative py-48 md:py-64 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/assets/images/cinema-07.jpg"
          alt="LuxuryCine — Final CTA"
          fill
          quality={85}
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-8 md:px-16 text-center">
        ...
        <motion.h2
          ...
          className="font-serif text-4xl md:text-6xl lg:text-7xl font-light text-[#F5F0E8] leading-[1.1] mb-8 max-w-3xl mx-auto"
        >
          Let's design a cinema
          <br />
          worth <em className="italic text-[#B8975A]">staying home for.</em>
        </motion.h2>
